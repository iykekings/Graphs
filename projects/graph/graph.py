...
class Graph:
    ...
    def dft(self, starting_vertex):
        ...
        while s.size() > 0:
            ...
            if v not in visited:
                ...
                print(v)
                visited.add(v)
                # then add all of it's neighbours to the top of the stack
                for next_vertex in self.vertices[v]:
                    s.push(next_vertex)
    ...
    def dft_recursive(self, vertex, visited=set()):
        ...
        # loop through the vertex' neighbours and call dft_recursive on them
        for neighbour in self.vertices[vertex]:
            #  cheack if neighbour has not been visited
            if neighbour not in visited:
                visited = self.dft_recursive(neighbour, visited)
        return visited
